...
import { UNICABLE_SITE } from '@univision/fe-commons/dist/constants/sites';
...
import { UNICABLE } from '@univision/fe-commons/src/constants/pageCategories';
...
import favicon from '../../assets/unicable/favicon.ico';
 ...
 * @returns {JSX}
 */
export function UnicablePage({ store, config }) {
  return (
    <Provider store={store}>
      <ErrorBoundary>
        ...
        <ContentTypeWrapper site={UNICABLE_SITE} />
...
UnicablePage.getInitialProps = async (context) => {
  return setupPage(context, UNICABLE);
};

UnicablePage.propTypes = {
...
const UnicablePageageWithRouter = withRouter(UnicablePage);

export default withRedux(configureStore)(UnicablePageageWithRouter);
