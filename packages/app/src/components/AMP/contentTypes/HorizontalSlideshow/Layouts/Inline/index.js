...
import AdSlide from '../../../../../contentTypes/HorizontalSlideshow/Slide/AdSlide';
import AmpSlideImage from '../../SlideImage';
import {
  Caption, CaptionContainer, Counter, Credit, ImageContainer, Slide, SlideBackground, Slideshow,
} from './InlineSlideshow.styles';
...
class InlineSlideshow extends Component {
   ...
   */
  constructor({ adSettings }) {
    super();
    this.advertisement = (
      <AdSlide
        inline
        advertisement={adHelper.getAd(AdTypes.IN_SLIDE_AD, adSettings)}
        active
      />
    );
  }
