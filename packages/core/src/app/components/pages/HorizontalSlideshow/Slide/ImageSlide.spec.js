...
import { hideAdByIds } from '@univision/fe-commons/dist/store/actions/ads-actions';
...
describe('ImageSlide', () => {
  ...
  it('should render without crashing', () => {
    ...
    ReactDOM.render(<ImageSlide {...imageProps} />, div);
  });

  it('should render without image renditions', () => {
    const props = { image: {} };
    const wrapper = mount(<ImageSlide {...props} />);
  ...
  it('should call dispatch if active', () => {
    ...
    wrapper.instance().UNSAFE_componentWillReceiveProps({ active: true });
  ...
  it('should not call dispatch if active', () => {
    Store.dispatch = jest.fn();
    const wrapper = shallow(<ImageSlide {...imageProps} />);
    wrapper.instance().UNSAFE_componentWillReceiveProps({ active: false });
  ...
  it('should work properly with bg image.', () => {
    const props = { ...imageProps, image: { renditions: { original: { href: 'test' } } } };
    const wrapper = shallow(<ImageSlide {...props} />);
    expect(wrapper.find('.background').prop('style')).not.toEqual({});
  });
});
