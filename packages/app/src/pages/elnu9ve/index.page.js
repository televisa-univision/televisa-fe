...
import { ELNU9VE_SITE } from '@univision/fe-commons/dist/constants/sites';
...
import { ELNU9VE } from '@univision/fe-commons/src/constants/pageCategories';
...
import favicon from '../../assets/elnu9ve/favicon.ico';
 ...
 * @returns {JSX}
 */
export function CanalNuevePage({ store, config }) {
  return (
    <Provider store={store}>
      <ErrorBoundary>
        ...
        <ContentTypeWrapper site={ELNU9VE_SITE} />
...
CanalNuevePage.getInitialProps = async (context) => {
  return setupPage(context, ELNU9VE);
};

CanalNuevePage.propTypes = {
...
const CanalNuevePageWithRouter = withRouter(CanalNuevePage);

export default withRedux(configureStore)(CanalNuevePageWithRouter);
