...
export const Body = styled.div`
  ...
  b {
    color: ${props => (props.theme?.custom?.b ? props.theme.custom.b : '#000')};
  }
...
export const TagLabel = styled.a`
  ...
  color: ${props => (props.theme?.tagLabelColor ? props.theme?.tagLabelColor : props.theme.primary)} !important;
