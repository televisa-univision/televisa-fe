...
class Form extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.filterTypeOptions = [
      { name: localization.get('all'), value: 'all' },
      ...optionsMapping(props.page.typeFilters),
    ];
 ...
 * @property {Object} page - the page with the defined filter data
 * @property {string} query - the query value for the input
 * @property {string} placeholder - the default value for the input
 * @property {number} resultSize - the size for resulting search
 * @property {array} results - the results from the api
 * @property {bool} loading - is the page loading
 * @property {func} onChangeFilterByType - handler used when dispatched a filter by type event
 * @property {func} onChangeFilterByDate - handler used when dispatched a filter by date event
 * @property {func} handleInputBlur - handler dispatched when the user blurs the input
 * @property {func} handleSubmitForm - handler dispatched when user hits submit
 */
Form.propTypes = {
