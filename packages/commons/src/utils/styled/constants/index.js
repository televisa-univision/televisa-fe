...
export const GRADIENT_TRANSPARENT_GREY_TO_GREY = 'linear-gradient(223deg, rgba(51,51,51,0.10) 14.65%, rgba(48,52,75,0.10) 0.10) 84.52%), linear-gradient(223deg, #333 14.65%, #30344B 84.52%);';
