...
import Styles from './DarkCover.stories.scss';
...
storiesOf('Widgets/DarkCover', module)
  .add('without image', () => (
    <DarkCover>
      <h1 className={Styles.headeline}>Hello World</h1>
    </DarkCover>
  ))
  .add('with image', () => (
    <DarkCover image={image}>
      <h1 className={Styles.headeline}>Hello World</h1>
    </DarkCover>
  ))
  .add('with image and device desktop', () => (
    <DarkCover image={image} device="desktop">
      <h1 className={Styles.headeline}>Hello World</h1>
    </DarkCover>
  ));
